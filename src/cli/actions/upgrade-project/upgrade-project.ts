...
import { listAvailableTemplates } from '../../../helpers/misc/list-available-templates.ts';
import { ROOT_PATH, getTemplateDirectoryPath } from '../../../helpers/misc/paths.constant.ts';
...
export function upgradeProject({ force = false, logger }: UpgradeProjectOptions): Promise<void> {
  return logger.asyncTask('upgrade-project', async (logger: Logger): Promise<void> => {
